      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="relative bg-gradient-to-br from-blue-50 to-blue-100 px-8 py-8 md:py-0 md:w-[280px] flex items-center justify-center">
              {/* Illustration */}
            ...
            <div className="flex-1 bg-gradient-to-r from-blue-800 to-blue-900 px-8 py-8 md:py-10 relative overflow-hidden">
              {/* Background Pattern */}
