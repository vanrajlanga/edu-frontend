      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div
          className={cn(
            ...
            'bg-blue-50',
            'group-hover:border-blue-400 group-hover:bg-blue-100',
            'transition-colors duration-200'
          )}
        >
          <Icon name={icon} size="lg" className="text-blue-800" />
        </div>
...
function StudyGoalSeeAllCard({ onClick, className }) {
  return (
    ...
    >
      <span className="text-blue-800 font-semibold text-lg group-hover:text-blue-900 transition-colors">
        See all
      </span>
      <div
        className={cn(
          ...
          'flex items-center justify-center',
          'group-hover:border-blue-800 group-hover:bg-blue-50',
          'transition-colors duration-200'
        )}
      >
        <Icon name="arrowRight" size="md" className="text-blue-800" />
      </div>
    </button>
  );
}
