  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        >
          <Icon name={icon} size="lg" className="text-blue-500" />
        </div>
...
function StudyGoalSeeAllCard({ href = '/courses', className }) {
  return (
    ...
    >
      <span className="text-blue-500 font-semibold text-lg group-hover:text-blue-600 transition-colors">
        See all
      </span>
      <div
        className={cn(
      ...
      >
        <Icon name="arrowRight" size="md" className="text-blue-500" />
      </div>
    </Link>
  );
}
